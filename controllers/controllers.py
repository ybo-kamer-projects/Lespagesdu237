...
class Academy(http.Controller):
    ...
    @http.route(['/academy/pagesblanches/'], auth='public', website=True,
                type="http")
    def pagesblanches(self, page=0, search=''):

        return request.render('academy.pagesblanches')
   ...
   # Résultats
    ...
    @http.route(['/academy/resultats/submit', '/academy/resultats/submit/page/<int:page>',  '/academy/pagesblanches/page/<int:page>'], type='http', auth="public", website=True)
